...
require 'simplecov'
SimpleCov.command_name 'test:Linx4PyEmit'
SimpleCov.start
gem 'test-unit'
require 'test/unit' 
...
class TC_Linx4PyEmit < Test::Unit::TestCase
  ...
  def test_signalclass_generatesignalclass
      ...
      ref_signalroot_class = GetRef.new.getSignalRootClassRefLinx4Py
      ...
      ref_signalstruct_class = GetRef.new.getSignalStructClassRefLinx4Py
  ...
  def test_signalclass_visitarray_2
      ...
      assert_equal(ref_recstr, recstr) 
      assert_equal(ref_sendstr, sendstr) 
      ref_testsig = ReadFile.new.readInTC("test/ref/ref_testsig_array_linx4py.py")
  ...
  def test_signalclass_visitnode_2
      ...
      assert_equal(0, ind)
      ref_testsig = ReadFile.new.readInTC("test/ref/ref_testsig_struct_linx4py.py")
      testsig = ReadFile.new.readInTC("test/testsig.py")
      assert_equal(ref_testsig, testsig)
      File.delete("test/testsig.py") if File.exist?("test/testsig.py")
  end
  ...
  def test_signalclass_visitnode_3
      ...
      sendstr = signal.instance_eval('@sendstr')
      ind = signal.instance_eval('@ind')
      ref_recstr = GetRef.new.getVisitNodeUnionRecstrLinx4Py
      ref_sendstr = GetRef.new.getVisitNodeUnionSendstrLinx4Py
      assert_equal(ref_recstr, recstr)
      assert_equal(ref_sendstr, sendstr)
      assert_equal(1, ind)
  end
